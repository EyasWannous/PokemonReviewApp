    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonCategory", x => new { x.CategroyId, x.PokemonId });
                    table.ForeignKey(
                        name: "FK_PokemonCategory_Categories_CategroyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonOwner", x => new { x.OwnerId, x.PokemonId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonOwner_PokemonId",
                table: "PokemonOwner",
                column: "PokemonId");
